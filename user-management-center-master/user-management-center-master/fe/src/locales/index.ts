...
// 导入语言文件
const langModules = import.meta.glob('./lang/*/index.ts', { eager: true }) as Record<string, any>;
...
export const i18n = createI18n({
  legacy: false,
  locale: localStorage.getItem(localeConfigKey) || 'en_US', // || browserLanguage
...
// @ts-ignore
export const { t, t: $t } = i18n.global;
